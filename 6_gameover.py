...
# 캐릭터 만들기
character = pygame.image.load(os.path.join(image_path, "치토1.png"))
...
# 무기 만들기
weapon = pygame.image.load(os.path.join(image_path, "치토2.png"))
...
while running:
    ...
    timer = game_font.render("Time : {}".format(int(total_time - elapsed_time)), True, (255, 255, 255)) #숫자는 RGB값임
...
# 게임 오버 메시지
msg = game_font.render(game_result, True, (255, 255, 0)) # 노란색(RG255,B0)
