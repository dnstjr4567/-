...
screen = pygame.display.set_mode((screen_width,screen_height)) #화면띄우는거
...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/pc/Desktop/모각소/background.png")


# 캐릭터 ( 스프라이트 ) 불러오기
character = pygame.image.load("C:/Users/pc/Desktop/모각소/치토2.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/pc/Desktop/모각소/치토1.png")
...
while running :
    dt = clock.tick(40) # 게임화면의 초당 프레임 수를 설정 30-60이 스무스 
